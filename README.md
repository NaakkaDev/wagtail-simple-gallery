...
Current version works with Wagtail 5.0.x - 7.0.x & Django 4.2.x - 5.2.x.

Versions higher than the ones mentioned above may also work, but are not tested as of now.
